...
class salesClass:
    def __init__(self,root):
        ...
        #===========title==============
        lbl_title=Label(self.root,text="View Customer Bills",font=("goudy old styly",30),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)
        ...
        lbl_title2=Label(bill_Frame,text="Customer Bill Area",font=("goudy old styly",20),bg="orange").pack(side=TOP,fill=X)
