...
class BillClass:
    def __init__(self,root):
        ...
        lbl_note=Label(ProductFrame1,text="Note:Enter 0 Quantity to remove product from cart.",font=("goudy old style",11),anchor='w',bg="white",fg="red").pack(side=BOTTOM,fill=X)
        ...
        btn_generate=Button(billMenuFrame,text='Generate Bill/Save Bill',command=self.generate_bill,font=("goudy old style",15,"bold"),bg="#009688",fg="white",cursor="hand2")
        btn_generate.place(x=246,y=80,width=160,height=50)

        #===========Footer==============
        footer=Label(self.root,text="IMS-Inventory Management System | Developed by Harsha\nFor any issues contact: 6361xxx852",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#==========================All Functions======================
    ...
    def add_update_cart(self):
        ...
        elif int(self.var_qty.get())>int(self.var_stock.set()):
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tXYZ Inventory
\t Phone No. 6361******, Bangalore-560097
{str("="*47)}
 Customer Name: {self.var_cname.get()}
 Phno. :{self.var_contact.get()}
...
{str("="*47)}\n
    ...
    def update_date_time(self):
        ...
        self.lbl_clock_.after(200,self.update_date_time)
